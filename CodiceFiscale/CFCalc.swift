...
class CFCalc {
    ...
    func calc( name:String, surname:String, isFemale:Int, bornDate:NSDate, cityCode:String) -> String
    {
        fiscalCode = elaborateSurname(surname)
        fiscalCode = fiscalCode + (" " + elaborateName(name) as String)
        fiscalCode = fiscalCode + (" " + " " + (elaborateDateString(bornDate, isFemale: isFemale) as String))
        fiscalCode = fiscalCode + (" " + cityCode)
        
        fiscalCode = fiscalCode + (elaborateControlCharacter(fiscalCode) as String)
        return fiscalCode
    }
    ...
    func elaborateSurname(var surname:String)->String{
        ...
        let str:NSString = surname
        var consonant:NSString = str
        var vowel:NSString = str
        var result:NSString = ""
        
        for _ in 0..<str.length{                                                                //remove vowel
        ...
        for _ in 0..<str.length{                                                                //remove consonant
        ...
        result = (consonant as String) + (vowel as String) + "XXX"
    ...
    func elaborateName(var name:String)->String{
        ...
        if(consonant.length <= 3){
            result = (consonant as String) + (vowel as String) + "XXX"      //string < 3 character
        }
        else{
